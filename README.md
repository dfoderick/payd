...
To explore the endpoints and functionality, run the server using `go run cmd/server/main.go` and navigate to [Swagger](http://localhost:8443/swagger/index.html) or go to the GitHub Pages hosting the spec [here](https://libsv.github.io/payd/) 
